...
class FraudDataGenerator:
    ...
    def generate(self, num_customers=NUM_CUSTOMERS, num_merchants=NUM_MERCHANTS,
               num_transactions=NUM_TRANSACTIONS, output_file="ecommerce_fraud_dataset.parquet"):
        """
        ...
        Args:
            ...
            num_merchants (int): Number of unique merchants to generate
            num_transactions (int): Number of transactions to generate
            output_file (str): Filename for the output parquet file
